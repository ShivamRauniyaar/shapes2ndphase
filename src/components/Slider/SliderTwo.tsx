...
const SliderTwo = () => {
  return (
    <>
      <div
        className={`slider-block style-two bg-linear xl:h-[860px] lg:h-[800px] md:h-[580px] sm:h-[500px] h-[350px] max-[420px]:h-[400px] w-full`}
      >
              ...
              <div className="slider-item h-full w-full relative">
                <div className="container w-full h-full flex items-center relative">
                  <div className="text-content basis-1/2 flex flex-col items-center">
                    ...
                    <div className="body1 text-center md:mt-4 mt-2">
              ...
              <div className="slider-item h-full w-full relative">
                <div className="container w-full h-full flex items-center relative">
                  <div className="text-content basis-1/2 flex flex-col items-center">
                    ...
                    <div className="body1 text-center md:mt-4 mt-2">
                      Get ready for the season with our latest collection of
                      women{String.raw`'s`} clothing
                    </div>
                    <Link
                      href="/shop/breadcrumb-img"
                      className="button-main md:mt-8 mt-3"
              ...
              <div className="slider-item h-full w-full relative">
                <div className="container w-full h-full flex items-center relative">
                  <div className="text-content basis-1/2 flex flex-col items-center">
                    ...
                    <div className="body1 text-center md:mt-4 mt-2">
                      Check out our curated selection of must-have outfits for
                      any occasion
                    </div>
                    <Link
                      href="/shop/breadcrumb-img"
