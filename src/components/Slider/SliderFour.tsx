              ...
              <div className="slider-item h-full w-full relative overflow-hidden">
                <div className="container w-full h-full">
                  <div className="text-content w-full h-full flex flex-col items-center justify-center">
                    <div className="text-sub-display text-white text-center">
                      Sale! Up To 50% Off!
                    </div>
                    <div className="text-display text-white text-center md:mt-5 mt-2">
                      Trendy Women{String.raw`'s`} <br />
                      Clothing
                    </div>
                    <Link
                      href="/shop/breadcrumb-img"
                      className="button-main bg-white text-black hover:bg-black hover:text-white md:mt-8 mt-3"
                    >
                      Shop Now
                    </Link>
                  </div>
