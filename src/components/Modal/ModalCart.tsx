...
const ModalCart = ({
  ...
  let [totalCart, setTotalCart] = useState<any>(0);

  const handleQuantity = (id: string, skucode: string, quantity: number) => {
    updateCart(id, quantity, skucode);
  };
                      ...
                      <div className="w-full">
                        <div className="flex items-center justify-between w-full">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              className="border-line mt-2 px-4 py-3 w-25 rounded-lg"
                              placeholder="1"
