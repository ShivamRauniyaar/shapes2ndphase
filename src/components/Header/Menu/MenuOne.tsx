  ...
  return (
    <>
      <div
        ...
        } top-0 left-0 right-0 w-full md:max-h-[112px] md:h-[112px] h-[64px] ${props}`}
      >
        <div className="container mx-auto h-full">
          <div className="lg:hidden flex justify-between items-center text-center h-full ">
            <div>
              {" "}
              <Image
            ...
            >
              {CommonSvg.mobiileHamburgerSvg}
            </div>
          </div>
          <div className="header-main flex flex-row-reverse justify-between h-full max-lg:hidden">
            <div
              className="menu-mobile-icon lg:hidden flex items-center"
              onClick={handleMenuMobile}
            >
                                          ...
                                          {item?.blogs?.map(
                                            (item: any, index: number) => (
                                              <div key={index}>
                                                ...
                                                <div className="caption1 text-secondary header_design text-left mt-3">
                                                  {item?.title}
                                                </div>
                                                <div>Read -</div>
                                              </div>
                      ...
                      return item?.children?.length === 0 ? (
                        ...
                        >
                          <Link
                            ...
                            className="text-xl font-semibold flex items-center justify-between mt-5 header_design"
                          >
                            {item?.title}
                        ...
                        >
                          <div className="text-xl mt-5 font-semibold flex items-center justify-between header_design">
                            {item?.title}
                            <span className="text-right">
                              <Icon.CaretRight size={20} />
                            </span>
                                        ...
                                        {(expandedCategories[
                                          ...
                                          >
                                            <div
                                              ...
                                              className="link text-secondary cursor-pointer header_design"
                                            >
                                              {sub?.subcatgeoryName}
                                            </div>
                                          </li>
                                        ...
                                        {catItem?.subcategoryData?.length >
                                          ...
                                          <li>
                                            <div
                                              ...
                                              className="link text-secondary cursor-pointer font-bold header_design"
                                            >
                                              {expandedCategories[
                                                catItem?.productCategoryID
                                              ]
