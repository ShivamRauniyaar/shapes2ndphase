        ...
        <div className="container">
          <div className="list-banner grid lg:grid-cols-3 md:grid-cols-2 gap-[20px]">
            <Link
              ...
              className="banner-item relative block rounded-[20px] overflow-hidden duration-500"
            >
              ...
              <div className="text-content xl:py-0 md:py-4 absolute top-1/2 left-8 -translate-y-1/2 text-white">
                ...
                <div className="heading6 font-normal mt-1">
                  Relax Bamboo Chair
                </div>
            ...
            <Link
              href={"/shop/breadcrumb1"}
              className="banner-item relative block rounded-[20px] overflow-hidden duration-500 max-lg:hidden"
            >
              <div className="banner-img w-full h-full">
                <Image
