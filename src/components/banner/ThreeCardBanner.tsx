...
const ThreeCardBanner = () => {
  return (
    <>
      <div className="banner-block md:pt-20 pt-10 pb-20">
        <div className="container">
          <div className="heading3 text-center pb-10">Products for every taste</div>
...
export default ThreeCardBanner;
